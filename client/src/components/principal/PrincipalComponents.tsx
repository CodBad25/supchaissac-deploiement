...
import { ModernDirectorDashboard } from "./ModernDirectorDashboard";
...
type Session = {
  ...
  comment?: string;
  createdAt?: string; // Date de création/saisie de la session
};
...
function DashboardWithData() {
  // Données simulées réalistes pour un établissement scolaire
  const simulatedSessions = [
    // RCD - Remplacements de Courte Durée
    { id: 1, type: "RCD", status: "PENDING_VALIDATION", date: "2025-08-20", teacherId: 4, teacherName: "Sophie Martin", totalAmount: 45.50, duration: 1, subject: "Mathématiques", className: "6A" },
    { id: 2, type: "RCD", status: "PENDING_VALIDATION", date: "2025-08-21", teacherId: 5, teacherName: "Pierre Dubois", totalAmount: 91.00, duration: 2, subject: "Français", className: "5B" },
    { id: 3, type: "RCD", status: "VALIDATED", date: "2025-08-19", teacherId: 6, teacherName: "Marie Leroy", totalAmount: 45.50, duration: 1, subject: "Histoire-Géo", className: "4A" },
    { id: 4, type: "RCD", status: "PAID", date: "2025-08-15", teacherId: 7, teacherName: "Jean Moreau", totalAmount: 136.50, duration: 3, subject: "Sciences", className: "3B" },

    // DEVOIRS_FAITS - Accompagnement éducatif
    { id: 5, type: "DEVOIRS_FAITS", status: "PENDING_VALIDATION", date: "2025-08-22", teacherId: 8, teacherName: "Claire Bernard", totalAmount: 35.20, duration: 1, subject: "Anglais", className: "6B" },
    { id: 6, type: "DEVOIRS_FAITS", status: "VALIDATED", date: "2025-08-20", teacherId: 9, teacherName: "Michel Petit", totalAmount: 70.40, duration: 2, subject: "EPS", className: "5A" },
    { id: 7, type: "DEVOIRS_FAITS", status: "PAID", date: "2025-08-18", teacherId: 10, teacherName: "Anne Roux", totalAmount: 35.20, duration: 1, subject: "Arts", className: "4B" },

    // HSE - Heures Supplémentaires Effectives
    { id: 8, type: "HSE", status: "PENDING_VALIDATION", date: "2025-08-23", teacherId: 11, teacherName: "David Garcia", totalAmount: 85.60, duration: 2, subject: "Technologie", className: "3A" },
    { id: 9, type: "HSE", status: "VALIDATED", date: "2025-08-21", teacherId: 12, teacherName: "Sylvie Blanc", totalAmount: 42.80, duration: 1, subject: "Espagnol", className: "2A" },
    { id: 10, type: "HSE", status: "PAID", date: "2025-08-16", teacherId: 13, teacherName: "Laurent Faure", totalAmount: 128.40, duration: 3, subject: "Musique", className: "1B" },

    // AUTRE - Autres activités
    { id: 11, type: "AUTRE", status: "PENDING_VALIDATION", date: "2025-08-22", teacherId: 4, teacherName: "Sophie Martin", totalAmount: 38.90, duration: 1, subject: "Surveillance", className: "Examen" },
    { id: 12, type: "AUTRE", status: "REJECTED", date: "2025-08-20", teacherId: 5, teacherName: "Pierre Dubois", totalAmount: 77.80, duration: 2, subject: "Formation", className: "Réunion" },
    { id: 13, type: "AUTRE", status: "VALIDATED", date: "2025-08-19", teacherId: 6, teacherName: "Marie Leroy", totalAmount: 38.90, duration: 1, subject: "Conseil", className: "Classe" },

    // Sessions supplémentaires pour volume
    { id: 14, type: "RCD", status: "PENDING_VALIDATION", date: "2025-08-23", teacherId: 7, teacherName: "Jean Moreau", totalAmount: 91.00, duration: 2, subject: "Sciences", className: "6A" },
    { id: 15, type: "DEVOIRS_FAITS", status: "PENDING_VALIDATION", date: "2025-08-23", teacherId: 8, teacherName: "Claire Bernard", totalAmount: 70.40, duration: 2, subject: "Anglais", className: "5B" },
    { id: 16, type: "HSE", status: "VALIDATED", date: "2025-08-22", teacherId: 9, teacherName: "Michel Petit", totalAmount: 85.60, duration: 2, subject: "EPS", className: "4A" },
    { id: 17, type: "RCD", status: "PAID", date: "2025-08-17", teacherId: 10, teacherName: "Anne Roux", totalAmount: 45.50, duration: 1, subject: "Arts", className: "3B" },
    { id: 18, type: "DEVOIRS_FAITS", status: "REJECTED", date: "2025-08-21", teacherId: 11, teacherName: "David Garcia", totalAmount: 35.20, duration: 1, subject: "Technologie", className: "2A" },
    { id: 19, type: "HSE", status: "PAID", date: "2025-08-14", teacherId: 12, teacherName: "Sylvie Blanc", totalAmount: 171.20, duration: 4, subject: "Espagnol", className: "1B" },
    { id: 20, type: "AUTRE", status: "VALIDATED", date: "2025-08-18", teacherId: 13, teacherName: "Laurent Faure", totalAmount: 77.80, duration: 2, subject: "Réunion", className: "Parents" }
  ];

  console.log('🎯 Données simulées pour dashboard:', simulatedSessions);
  console.log('📊 Nombre de sessions:', simulatedSessions.length);

  return <ModernDirectorDashboard sessions={simulatedSessions} />;
}
  ...
  return (
    <Tabs defaultValue="dashboard" className="w-full">
      <TabsList className="mb-4 flex flex-wrap gap-1 justify-center">
        <TabsTrigger value="dashboard" className="px-2 py-1 text-xs sm:text-sm">
  ...
  const initialSessions: Session[] = [
    {
      ...
      attachments: [],
      createdAt: '2025-03-07T08:35:21' // Saisie le même jour
    },
    {
      id: 2,
      ...
      createdAt: '2025-03-13T16:42:19' // Saisie le lendemain
    },
    {
      id: 3,
      ...
      createdAt: '2025-03-19T09:15:43' // Saisie le lendemain
    }
  ];
    ...
    <div className="space-y-6">
      <div className="bg-white rounded-lg shadow p-4 sm:p-6 border border-gray-200">
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-lg font-semibold">Séances en attente de validation</h3>
        ...
        {pendingSessions.length > 0 ? (
          <div className="overflow-x-auto">
            <Table className="w-full">
              <TableHeader>
                <TableRow>
                  <TableHead className="text-xs sm:text-sm w-16">Date séance</TableHead>
                  ...
                  <TableHead className="text-xs sm:text-sm hidden sm:table-cell">Date saisie</TableHead>
