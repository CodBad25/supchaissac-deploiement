  ...
  return (
    <Tabs defaultValue="users" className="w-full">
      <TabsList className="mb-4 flex flex-wrap gap-1 justify-center">
        <TabsTrigger value="users" className="px-2 py-1 text-xs sm:text-sm">
          Utilisateurs
        </TabsTrigger>
        <TabsTrigger value="import" className="px-2 py-1 text-xs sm:text-sm">
          Import CSV
        </TabsTrigger>
        <TabsTrigger value="settings" className="px-2 py-1 text-xs sm:text-sm">
          Paramètres
        </TabsTrigger>
      </TabsList>
