import { users, sessions, teacherSetups, systemSettings, User, InsertUser, Session, InsertSession, TeacherSetup, InsertTeacherSetup, SystemSetting, InsertSystemSetting } from "@shared/schema";
...
export class MemStorage implements IStorage {
  ...
  constructor() {
    ...
    this.createUser({
      ...
      password: "password123",
      name: "Admin",
      role: "PRINCIPAL", // Using principal role for admin as it has the highest privileges
    });
    ...
    // Sessions pour l'enseignant 1 (Sophie MARTIN)
    this.createSession({
      teacherId: 1,
    ...
    // Sessions pour l'enseignant 3 (Martin DUBOIS)
    this.createSession({
      teacherId: 3,
...
// Initialiser le paramètre de délai de modification des sessions
